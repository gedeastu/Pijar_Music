  ...
  return (
    <>
      <div className="md:hidden overflow-y-auto">
        <button
          onClick={showTopBar}
          className="md:hidden text-black duration-500 transition-all"
        >
          {topBar ? (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              id="close"
              className="fixed z-[99] top-8 fill-[#FF6002] transition-all duration-500"
              height="2em"
              viewBox="0 0 384 512"
            >
            ...
            <svg
              xmlns="http://www.w3.org/2000/svg"
              id="bars"
              className="transition-all fill-white duration-500 focus:rotate-180"
              height="2em"
              viewBox="0 0 448 512"
            >
        ...
        {topBar ? (
          <>
            <div className="transition-all duration-500 left-0 fixed z-[60] top-0">
              <div className="h-96 bg-white shadow-xl opacity-100 w-screen ease-in-out transition-all duration-500"></div>
            </div>
            <div
              id="disableScroll"
              className="bg-black fixed opacity-20 z-[55] top-0 left-0 w-full transition duration-500 ease-in-out h-screen overflow-y-auto"
            ></div>
          </>
        ) : (
          <>
