...
export default function OurCampaign(){  
    return(
        ...
        className='text-black bg-transparent rounded-lg w-full pb-20 relative z-50 mt-10 flex flex-row items-start md:mt-20'
        >
        
        <SwiperSlide className='flex flex-col justify-center items-center'>
        <div className='bg-white w-full h-[28rem] rounded-lg px-5'>
            <div className='w-full h-52 mx-auto my-5 rounded-lg overflow-hidden'>
            ...
            <div id="stats" className='bg-transparent w-full py-10 px-5 rounded-md'>
