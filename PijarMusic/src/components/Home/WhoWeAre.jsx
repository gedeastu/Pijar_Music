      ...
      <article className="h-max  w-full flex flex-col gap-40 py-20 px-7 md:px-28 md:py-[10rem] md:flex-row md:items-center md:gap-0 md:justify-between">
        <aside className="relative pl-8 flex flex-row items-center">
          <div className="w-[20rem] h-[25rem] relative md:w-[30rem] md:h-[35rem]">
            <svg
              className="absolute top-10 z-20 -left-7 h-16 md:h-24 md:-left-10"
              viewBox="0 0 85 85"
              fill="none"
              ...
              <defs>
                <clipPath id="clip0_1_249">
                  <rect
                    ...
                    height="47.1311"
                    fill="white"
                    transform="translate(18.8525 18.9836)"
                  />
                </clipPath>
              </defs>
            </svg>
        ...
        <article className="flex flex-col justify-center items-start gap-8 md:pb-0">
          <div id="titleDesc" className="flex flex-col gap-3">
            <h1 className="text-[#FF6002] font-semibold font-outfit text-2xl md:text-4xl">
              Who we are
            </h1>
            <h2 className="text-black font-outfit font-semibold text-3xl md:text-6xl">
              We’re Volunteers Community
              <br />& Artist{" "}
            </h2>
            <div className="bg-[#FF6002] w-20 h-2 rounded-full md:w-32"></div>
            <p className="text-black font-outfit text-md md:text-2xl">
              Join us and make your life more valuable and useful, be a part of
              us
              <br />
          ...
          <button className="font-outfit bg-[#FF6002] font-semibold h-14 w-32 flex items-center justify-center rounded-lg text-white md:w-52 md:h-16">
            About Us
          </button>
        </article>
      </article>
